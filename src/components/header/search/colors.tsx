...
export default function Colors({
  ...
  return (
    <div className=" w-full    border-b-1 pb-4 lg:pb-0  lg:border-b-transparent   border-black/50">
      ...
      <div className="grid grid-cols-8 sm:grid-cols-12 md:grid-cols-16 lg:grid-cols-7 xl:grid-cols-8  gap-2 mb-4 place-items-start justify-center  cursor-pointer">
      ...
      <div className="grid grid-cols-8 sm:grid-cols-12 lg:grid-cols-7 xl:grid-cols-8  gap-2 mb-4 cursor-pointer place-items-start justify-center">
