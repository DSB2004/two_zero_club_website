...
import { ChevronDownIcon, Plus, Minus, ArrowRight } from "lucide-react";
  ...
  return (
    ...
    >
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "focus-visible:border-ring px-4 focus-visible:ring-ring/50 flex flex-1 items-start justify-between gap-4 rounded-md py-4 text-left text-sm font-medium transition-all outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50",
          className
        )}
        {...props}
      >
