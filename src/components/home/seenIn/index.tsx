...
export default function SeenIn() {
  return (
    <section className="max-w-[1800px] px-4 lg:px-16  w-full m-auto my-0 py-[25px] sm:py-0 sm:my-20 space-y-[1.5rem]">
      ...
      <div className="xl:hidden overflow-hidden relative my-[25px]">
