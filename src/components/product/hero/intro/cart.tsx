...
export default function Cart() {
  ...
  return (
    <Button
      disabled={isPending}
      onClick={handleClick}
      className="bg-[#F33C14] hover:bg-[#ee3b13] flex items-center justify-center font-[area] rounded-full text-[0.75rem] md:text-[1rem] font-semibold px-5  flex-1 !h-[40px]"
    >
      {isPending ? (
        <>
