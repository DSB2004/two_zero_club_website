    ...
    <div>
      ...
      <Accordion type="multiple" className="border-t-2 border-black mt-5">
        <AccordionItem value="item-1" className="!border-b-2 border-black">
          <AccordionTrigger className="  px-4 !py-3 !text-[1rem] font-[area] !font-extrabold">
            Details
          </AccordionTrigger>
          <AccordionContent className="flex flex-col gap-4 font-[area] max-h-50 overflow-y-auto !text-[1rem] px-4">
            <p className="w-fit">
        ...
        <AccordionItem value="item-2" className="!border-b-2 border-black">
          ...
          <AccordionContent className="flex max-h-[600px] flex-col gap-4 font-[area]  overflow-y-auto !text-[1rem] px-4">
            <p className="w-fit">
